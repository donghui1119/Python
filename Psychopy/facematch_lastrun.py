...
expName = 'facematch'  # from the Builder filename that created this script
expInfo = {'participant': '', 'session': '001', 'age': '', 'gender': ''}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='F:\\psychopy\\facematch\\facematch_lastrun.py',
...
instr_text = visual.TextStim(win=win, name='instr_text',
    text='if the face is same, please press left key\n\nif the face is different, please press right key\n\nlet us start it by pressing any keys',
    font='Arial',
...
text = visual.TextStim(win=win, name='text',
    text='left',
    font='Arial',
    pos=(-1, -1), height=0.1, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=-2.0);
...
instructionComponents = [instr_text, key_resp]
...
for thisTrial in trials:
    ...
    _resp_allKeys = []
    # keep track of which components have finished
    trialComponents = [faces, resp, text, text_2]
